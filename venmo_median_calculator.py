    ...
    def __init__(self, TextLine):
        ...
        try:
            ...
            if '' not in [self.Time, self.Actor, self.Target]:
                ...
                global CurrentGraph
                CurrentGraph.NewEntry(self)  # Calls graph update
        except:
            pass
...
class Graph:
    ...
    It takes one PaymentEntry object as an argument and reconstructs the
    Current graph for each new entry
    ...
    def NewEntry(self, Entry):
        # This function is called by each new PaymentEntry object
        ...
        global txtCreator
        txtCreator.NewEntry(self.Edges)  # Recalculate median
